...
/**
 * Sample program that prints an EBCDIC MVS dataset pointed to by args[0]
...
public class ZFilePrint {
    public static void main(String[] args) throws Exception {
    	System.out.println("Running ZFilePrint for @" + args[0] + "@");
        ZFile zFile = new ZFile(args[0], "rb,type=record,noseek");
        try {
