pipeline {
    ...
    stages {
        ...
        stage('Build zOSFile') {
            steps {
                sh '/usr/lpp/java/J8.0_64/bin/javac -cp .:usr/lpp/java/J8.0_64/lib/*.jar:usr/lpp/java/J8.0_64/lib/ext/*.jar:/opt/lpp/IBM/dbb/lib/*.jar -d bin src/main/java/polycephalyzOSFile/*.java'
            }
        }
        stage('Build zOSUtilities') {
            steps {
                sh '/usr/lpp/java/J8.0_64/bin/javac -cp .:usr/lpp/java/J8.0_64/lib/*.jar:usr/lpp/java/J8.0_64/lib/ext/*.jar:/opt/lpp/IBM/dbb/lib/*.jar -d bin src/main/java/polycephalyzOSUtilities/*.java'
            }
        }
        ...
        stage('Build CICS Utilities') {
            steps {
                sh '/opt/lpp/IBM/dbb/groovy-2.4.12/bin/groovyc -cp .:usr/lpp/java/J8.0_64/lib/*.jar:usr/lpp/java/J8.0_64/lib/ext/*.jar:/opt/lpp/IBM/dbb/lib/*.jar -d bin src/main/groovy/polycephalyCICSUtilities/*.groovy' 
            }
        }
        stage('Build Languages') {
            steps {
                sh '/opt/lpp/IBM/dbb/groovy-2.4.12/bin/groovyc -cp .:usr/lpp/java/J8.0_64/lib/*.jar:usr/lpp/java/J8.0_64/lib/ext/*.jar:/opt/lpp/IBM/dbb/lib/*.jar -d bin src/main/groovy/polycephalyLanguages/*.groovy'
            }
        }
        stage('Build zOS Groovy Utilities') {
            steps {
                sh '/opt/lpp/IBM/dbb/groovy-2.4.12/bin/groovyc -cp .:usr/lpp/java/J8.0_64/lib/*.jar:usr/lpp/java/J8.0_64/lib/ext/*.jar:/opt/lpp/IBM/dbb/lib/*.jar -d bin src/main/groovy/polycephalyzOSGroovyUtilities/*.groovy'   
            }
        }
